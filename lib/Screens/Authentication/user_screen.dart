...
import 'package:provider/provider.dart';
 // Để dùng SplashScreen từ file main.dart
import '../../main.dart';
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // Phần content
            FutureBuilder(
              future: context.read<UserProvider>().getUserCurruent(),
              initialData: null,
              builder: (BuildContext context , AsyncSnapshot snapshot){
                  ...
                  StudentProfile data = snapshot.data as StudentProfile;
                  final String fullName = "${data.ho} ${data.ten}";
                  final Map<String, String> info = {
                    "Mã sinh viên:": data.maSinhVien,
                    "Giới tính:": data.gioiTinh,
                    "Ngày sinh:": data.ngaySinh,
                    "Nơi sinh:": data.noiSinh,
                    "Quốc tịch:": "Việt Nam",
                    "Số điện thoại:": data.diDong,
                    "Email:": data.email,
                    "Địa Chỉ Thường Trú": data.diaChiThuongTru,
                    "Địa Chỉ Cư Trú": data.diaChiCuTru
                  };
